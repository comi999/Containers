...
// - Partition CRefArray<V> (const CIterator&, const CIterator&) const
// - Reverse void ()
...
// - TrueForAll bool (CIterator, const CIterator&, const Predicate<const V&>&) const
...
// - Partition RefArray<V> (const CIterator&, const CIterator&)
// - Partition CRefArray<V> (const CIterator&, const CIterator&) const
// - Reverse void ()
// - Reverse void (const CIterator&, const CIterator&)
// - Size size_t () const
...
// - Sort void <bool>(const Predicate<const ValueType&, const ValueType&>&)
// - Sort void <bool>(CIterator&, CIterator&, const Predicate<const ValueType&, const ValueType&>&)
...
// - TrueForAll bool (const Predicate<const V&>&) const
// - TrueForAll bool (Iterator, const Iterator&, const Predicate<V&>&) const
// - TrueForAll bool (CIterator, const CIterator&, const Predicate<const V&>&) const
...
// - TrueForAll bool (const Predicate<V&>&)
// - TrueForAll bool (const Predicate<const V&>&) const
// - TrueForAll bool (Iterator, const Iterator&, const Predicate<V&>&)
// - TrueForAll bool (CIterator, const CIterator&, const Predicate<const V&>&) const
// - Underlying vector<V> ()
...
// - ToList List<V> ()
// - ToList List<V> () const
// - ToDictionary Dictionary<U, V> (const Invoker<U, const V&>&)
// - ToDictionary Dictionary<U, V> (const Invoker<U, const V&>&) const
// - ToDictionary Dictionary<U, W> (const Invoker<U, const V&>&, const Invoker<W, const V&>&)
// - ToDictionary Dictionary<U, W> (const Invoker<U, const V&>&, const Invoker<W, const V&>&) const
// - ToSet Set<V> ()
// - ToSet Set<V> () const
// - ToPartitionArray PartitionArray<V> ()
// - ToPartitionArray PartitionArray<V> () const
// - TrueForAll bool (const Predicate<V&>&)
// - TrueForAll bool (const Predicate<const V&>&) const
// - TrueForAll bool (Iterator, const Iterator&, const Predicate<V&>&)
...
// CEnumerable
// - CEnumerable(V[])
// - CEnumerable(const Iter&, const Iter&)
// - CEnumerable(const Iter&, const Iter&, size_t)
// - CEnumerable(Container&)
// - AsRefArray CRefArray<V> () const
// - AsCRefArray CRefArray<V> () const
// - At const V& (size_t) const
// - Back const V& () const
